...
const FoodItem = ({ id, name, price, description, image }) => {
  const { cartItem, add_in_cart, delete_from_cart, url  } = useContext(StoreContext);

  return (
    <div className="w-full m-auto rounded-[50px] shadow-[0_0_10px_#00000015] transition duration-300 Anima-2 flex flex-col min-h-[360px] bg-white">
